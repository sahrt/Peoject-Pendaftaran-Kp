...
// ambil objek data
$data = new readUjianKp ();
// ambil data pada tabel pendaftar kp
$dataRead = $data -> ambildata("SELECT * FROM pendaftaran_ujian_kp");

if (isset($_POST["cari"])) {
  $dataRead = search($_POST["keyword"],'pendaftaran_ujian_kp','Id','Jadwal_Ujian','Pendaftaran_Kp_Id'); 
  }
                         ...
                         <h1>Daftar Ujian Kp</h1>
                          ...
                          <div class="row" style="margin-top: 30px;">
                            ...
                            <tr>
                              ...
                              <th scope="col">Pendaftar Kp Id</th>
                              <th scope="col">Acc Ujian Id</th>
                            </tr>
                          ...
                          <?php foreach ($dataRead as $Kp ) : ?>
                            ...
                            <tr>
                              <td><?= $nomor; ?></td>
                              <td>
                                <a href="ubahPendaftaranUjianKp.php?id=<?= $Kp["Id"]?>"><img src="assets/img/editing.png" style="width:20px;"></a>|
                                <?php //<-- onclik disini untuk konfirmasi jika datanya mau dihapus --> ?>
                                
                                <a href="deletePendaftaranUjianKp.php?id=<?= $Kp["Id"];?>" onclick= " return confirm ('apakah anda yakin menghapus data ini?');"><img src="assets/img/remove.png" style="width:20px;"></a>
                              </td>
                              <td><?= $Kp["Id"]; ?></td>
                              <td><a href="viewPendafUjianKp.php?name=<?=$Kp["Laporan_KP"];?>"><?= $Kp["Laporan_KP"]; ?></a></td>
