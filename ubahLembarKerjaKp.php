...
//hubungkan file yang dibutuhkan

  require_once 'lembarKerjaKp.php';
  require_once 'function.php';

//kita buat class inheriten kedalam lembar-kp
  class ubahdata extends Lembar_Kp{
    //tambahakan atribut baru
    private $id;
    public $lembarLama;
    function setAtribut (){
      $this ->id;
...
// cek user pencet tombol ubah
  if (isset($_POST['submit'])) {
    //buat objek 
    $data = new ubahdata ();
    //jalankan method yang dibutuhkan
    $inputUser = $data -> ambilUserFrom($_POST);
    $file = $data -> ambilFile($_FILES);
    // cke apakah berhasil diubah
    if(ubahDataKp($inputUser,$file) > 0){
      echo "
      <script>
  ...
  $dataKp = query("SELECT * FROM lembar_kerja_kp WHERE id = $id")[0];
    ...
    <section class="section dashboard">
      <div class="row" style="color: black;">
        ...
        <div class="col">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Ubah Data Lembar Kerja KP</h5>
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="FileLama" value="<?= $dataKp["Nama _File"]; ?>">
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Ketua Kelompok </label>
                  <div class="col-sm-10">
                       <select class="form-select" aria-label="Default select example" name="anggota">
                      <option selected>Open this select menu</option>
                        <?php // looping data untuk select ?>
