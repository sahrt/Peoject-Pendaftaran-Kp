...
$dataNilai = query ("SELECT * FROM nilai");
  ...
  <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="index.html">Melihat Nilai</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Melihat Nilai KP</h5>
                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Bukti_Nilai</th>
                      <th scope="col">Ujian_Kp_Id</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php $nomor = 1; ?>
                    ...
                    <tr>
                      ...
                      <td><?= $key['Id'] ?></td>
                      <td><?= $key['Nilai_lapangan'] ?></td>
                      <td><?= $key['Nilai_Pembimbing'] ?></td>
                      <td><?= $key['Nilai_Penguji'] ?></td>
                      <td><?= $key['Bukti_Nilai'] ?></td>
                      <td><?= $key['Ujian_Kp_Id'] ?></td>
