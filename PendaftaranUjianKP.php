...
class PendaftaranUjianKp {
  ...
  function getPendaftaranKpId (){
    return $this ->PendaftaranKpId;
 
  }
  function getaccUjianKp (){
    ...
    <section class="section dashboard">
      <div class="row" style="color: black;">
        ...
        <div class="col">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Formulir Pendaftaran Ujian KP</h5>
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" type="file" id="formFile" name="laporan_kp" required>
                  </div>
                </div>
                 <div class="row mb-3">
